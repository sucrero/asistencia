<form class="well form-inline" id="formHorario">
                <fieldset>
                  ...
                  <div class="pull-right">
                    ...
                    <legend><h1><small><input type="checkbox" checked="" value="M" id="dia1" name="eli_dia[]"/> Martes</small></h1></legend>
                    <div class="control-group">
                        <div class="row">
                            <div class="span8 offset2">
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker5" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time5" type="text" class="span8" value="07:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker6" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time6" type="text" class="span8" value="12:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker7" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time7" type="text" class="span8" value="13:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker8" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time8" type="text" class="span8" value="17:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                    ...
                    <legend><h1><small><input type="checkbox" checked="" value="X" id="dia1" name="eli_dia[]"/> Mi&eacute;rcoles</small></h1></legend>
                    <div class="control-group">
                        <div class="row">
                            <div class="span8 offset2">
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker9" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time9" type="text" class="span8" value="07:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker10" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time10" type="text" class="span8" value="12:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker11" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time11" type="text" class="span8" value="13:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker12" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time12" type="text" class="span8" value="17:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                    ...
                    <legend><h1><small><input type="checkbox" checked="" value="J" id="dia1" name="eli_dia[]"/> Jueves</small></h1></legend>
                    <div class="control-group">
                        <div class="row">
                            <div class="span8 offset2">
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker13" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time13" type="text" class="span8" value="07:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker14" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time14" type="text" class="span8" value="12:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker15" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time15" type="text" class="span8" value="13:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker16" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time16" type="text" class="span8" value="17:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                    ...
                    <legend><h1><small><input type="checkbox" checked="" value="V" id="dia1" name="eli_dia[]"/> Viernes</small></h1></legend>
                    <div class="control-group">
                        <div class="row">
                            <div class="span8 offset2">
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker17" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time17" type="text" class="span8" value="07:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker18" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time18" type="text" class="span8" value="12:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker19" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time19" type="text" class="span8" value="13:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker20" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time20" type="text" class="span8" value="17:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                    ...
                    <legend><h1><small><input type="checkbox" value="S" id="dia1" name="eli_dia[]"/> S&aacute;bado</small></h1></legend>
                    <div class="control-group">
                        <div class="row">
                            <div class="span8 offset2">
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker21" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time21" type="text" class="span8" value="07:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker22" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time22" type="text" class="span8" value="12:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker23" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time23" type="text" class="span8" value="13:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker24" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time24" type="text" class="span8" value="17:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                    ...
                    <legend><h1><small><input type="checkbox" value="D" id="dia1" name="eli_dia[]"/> Domingo</small></h1></legend>
                    <div class="control-group">
                        <div class="row">
                            <div class="span8 offset2">
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker25" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time25" type="text" class="span8" value="07:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker26" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time26" type="text" class="span8" value="12:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker27" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time27" type="text" class="span8" value="13:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
                                ...
                                <div class="span3">
                                    ...
                                    <div id="datetimepicker28" class="input-append">
                                        <input data-format="hh:mm:ss"  id="time28" type="text" class="span8" value="17:00:00" readonly=""></input>
                                        <span class="add-on">
                                            <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
