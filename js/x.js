...
function xInclude(url1, url2, etc)
{
  if (document.getElementById || document.all || document.layers) { // minimum dhtml support required
    ...
    for (var i=0; i<arguments.length; ++i) { // loop thru all the url arguments
      ...
      // but in different directories? If I don't extract it what about: '../foo.js' and '<? echo base_url(); ?>foo.js' ?
...
/**********************************************************************************************************************/
/******************************Reproductor de galeria de Imagenes*******Agregado por:*Ricardo**************************/
/*********************************************************************************************************************/
//retardo entre imagenes en la reproduccion automatica (milisegundos)  
  var retardo_rotacion = 5000  
