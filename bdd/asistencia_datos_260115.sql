...
-- Started on 2015-01-26 20:35:54 VET
...
CREATE TABLE usuario (
    ...
    cedulausu character varying(10),
    nombusu character varying(50),
    apeusu character varying(50)
);
...
--
-- TOC entry 1939 (class 0 OID 35676)
-- Dependencies: 176 1940
-- Data for Name: asistencia; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY asistencia (idasis, idper, hora, fecha) FROM stdin;
4	21	22:09:08-04:30	2015-01-22
\.
...
SELECT pg_catalog.setval('asistencia_idasis_seq', 4, true);


--
-- TOC entry 1933 (class 0 OID 35540)
-- Dependencies: 170 1940
-- Data for Name: diasfestivo; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY diasfestivo (idfestivo, fecha, descfest) FROM stdin;
1	2015-12-24 00:00:00	NOCHE BUENA
3	2015-05-01 00:00:00	PRIMERO DE MAYO
\.
...
--
-- TOC entry 1927 (class 0 OID 35490)
-- Dependencies: 164 1940
-- Data for Name: horario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY horario (idhor, horentrada, horasalida, descripcionhor) FROM stdin;
7	07:00:00	12:00:00	ADMINISTRATIVO
8	07:00:00	12:00:00	VIGILANTE 1
9	01:00:00	18:00:00	VIGILANTE 2
\.
...
SELECT pg_catalog.setval('horario_idhor_seq', 9, true);


--
-- TOC entry 1935 (class 0 OID 35551)
-- Dependencies: 172 1940
-- Data for Name: horario_persona; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY horario_persona (idhorper, idper, idhor) FROM stdin;
11	19	7
12	20	7
13	21	7
14	22	7
...
SELECT pg_catalog.setval('horario_persona_idhorper_seq', 18, true);


--
-- TOC entry 1929 (class 0 OID 35514)
-- Dependencies: 166 1940
-- Data for Name: permiso; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY permiso (idper, descper) FROM stdin;
1	Permiso Medico (PM)
2	Permiso Injustificado (PI)
\.
...
--
-- TOC entry 1931 (class 0 OID 35522)
-- Dependencies: 168 1940
-- Data for Name: permiso_persona; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY permiso_persona (idperper, idpersona, desde, hasta, descripcionper, idpermiso) FROM stdin;
\.
...
--
-- TOC entry 1925 (class 0 OID 35482)
-- Dependencies: 162 1940
-- Data for Name: personal; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY personal (idper, cedper, nomper, apeper, emailper, dependencia, telfper, cargo, condicion) FROM stdin;
19	15742854	LUISA	JIMENEZ	ljimenez@hotmail.com	NACIONAL	04124561256	ADMINISTRATIVO	TITULAR
20	18456789	RAMON	PEREZ	rperez@gmail.com	ESTADAL	04164587892	OBRERO	COLABORADOR
21	12345678	JUAN	SOTILLO	jsotillo@hotmail.com	ESTADAL	04124567897	ADMINISTRATIVO	COLABORADOR
22	15742456	CARLOS	RAMOS	cramos@hotmail.com	ALCALDIA	04124567965	OBRERO	COLABORADOR
24	12345687	ANGELICA	LUIS	aluis@hotmail.com	ALCALDIA	04124567896	ADMINISTRATIVO	INTERINO
25	11542589	CECILIO	GOMEZ	cgomez@hotmail.com	NACIONAL	04144587896	ADMINISTRATIVO	SUPLENTE
26	10254145	MARIA	FERNENDEZ	mfernandez@hotmail.com	ALCALDIA	04125634578	MADRE PROCESADORA	INTERINO
\.
...
SELECT pg_catalog.setval('personal_idper_seq', 26, true);


--
-- TOC entry 1937 (class 0 OID 35586)
-- Dependencies: 174 1940
-- Data for Name: usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY usuario (idusuario, nombreusu, claveusu, tipousu, fechausu, statususu, cedulausu, nombusu, apeusu) FROM stdin;
1	JPEREZ	$2a$08$uaJAHROoRVxbo3efxT9Uk.Ypw7SgQ88vgtRjB/X1Y8h.Ap4GWRjqi	ADMINISTRADOR	2015-01-17 08:01:56	ACTIVO	1234567	JUAN	PEREZ
\.
...
-- Dependencies: 164 172 1804 1941
...
--
-- TOC entry 1822 (class 2606 OID 35691)
-- Dependencies: 176 162 1802 1941
...
-- Dependencies: 162 1802 172 1941
...
--
-- TOC entry 1819 (class 2606 OID 35701)
-- Dependencies: 168 166 1806 1941
...
--
-- TOC entry 1818 (class 2606 OID 35696)
-- Dependencies: 1802 168 162 1941
...
-- Completed on 2015-01-26 20:35:54 VET
